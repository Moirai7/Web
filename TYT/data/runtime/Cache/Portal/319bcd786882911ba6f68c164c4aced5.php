      ...
      <table class="table table-bordered">
        ...
        <tr>
          <td>
			...
			<?php if(empty($smeta['thumb'])): ?><img src="/tyt/statics/images/icon/upload-pic.png" id='thumb_preview' width='135' height='113' style='cursor:hand' />
			<?php else: ?>
      ...
      <table class="table table-bordered">
            ...
            <tr>
              ...
              <td><div id='content_tip'></div>
                ...
                <script type="text/javascript"  src="/tyt/statics/js/ueditor/ueditor.config.js"></script>
                <script type="text/javascript"  src="/tyt/statics/js/ueditor/ueditor.all.min.js"></script>
				</td>
            </tr>
            <tr>
              <th width="80">相册图集 </th>
