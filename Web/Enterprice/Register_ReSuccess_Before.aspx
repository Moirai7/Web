<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register_ReSuccess_Before.aspx.cs" Inherits="Web.Enterprice.Register_ReSuccess_Before" %>
<!DOCTYPE html>
			...
			<div class="col-md-6 col-md-push-3 col-xs-10 col-xs-push-1 col-sm-8 col-sm-push-2">
				<div id="content">
					<div class="row">
						<!-- 错误信息 -->
						<font color="red"></font>
						<form id="defaultForm" class="form-vertical bv-form" enctype="multipart/form-data" novalidate="novalidate"><button type="submit" class="bv-hidden-submit" style="display: none; width: 0px; height: 0px;"></button>
							...
							<div class="form-group form-actions">
								<asp:Button runat="server" class="btn btn-primary btn-lg" style="border-radius: 3px;" Text="确认"></asp:Button>
							</div>
						</form>
