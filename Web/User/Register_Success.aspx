...
<!DOCTYPE html>
<!-- saved from url=(0111)http://www.oxcoder.com/user-check-email.action?email=1509193642@qq.com&regcode=bc57770268dfcb62ebd86ba80aa5bcc1 -->
<html lang="en">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-md-push-3 col-xs-10 col-xs-push-1 col-sm-8 col-sm-push-2">
				<section id="middle">
					<form id="defaultForm" method="post" class="form-vertical" action="http://www.oxcoder.com/oxcoder_corp_step3.html">
...
<!-- 								</div> -->
							...
							<a href="http://www.oxcoder.com/index.action" class="btn btn-primary" style="float: right;">进入挑战</a>
						</div>
					</form>
				</section>
			</div>
