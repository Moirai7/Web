                ...
                <section id="Section2" class="col-md-12">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="User_Challenge.aspx?flag=history&reustate=all">全部</a></li>
                            <li><a href="User_Challenge.aspx?flag=history&reustate=unfinished">未完成的挑战</a></li>
                            <li><a href="User_Challenge.aspx?flag=history&reustate=passed">通过的挑战</a></li>
                            <li><a href="User_Challenge.aspx?flag=history&reustate=failed">不通过的挑战</a></li>
                        </ul>
                    </div>
                </section>
