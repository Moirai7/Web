<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Resume.aspx.cs" Inherits="Web.Enterprise.Resume" %>

<!DOCTYPE html>
<!-- saved from url=(0082)http://www.oxcoder.com/hr-recruit-resume-list.action?reid=1116&searchOrder=ranking -->
			...
			<div class="col-md-12">
				<div class="col-xs-12 col-no-left-padding">
					<h1 class="pull-left">
						...
						<a href="http://www.oxcoder.com/hr-recruit-switch.action?flag=recruitinfo&reid=1116&restate=0"><button class="btn btn-new1 pull-right" style="margin-top: 20px;">关闭该挑战</button></a>
					
					
				</div>
				<small> <a href="http://www.oxcoder.com/hr-recruit-list.action"><i class="imoon imoon-arrow-left2"></i> 返回 </a>
					</small>
			</div>

			<div class="col-md-12">
				<div class="challenge-simple-desc">
					<span class="desc-label">发起时间：2015-05-20</span> <span class="desc-label">接受挑战：0</span>
