...
<div class="sidebar sting ">
  <h1><i class="fa fa-bars push"></i>Account <span class="color">Menu</span></h1>
	...
	<li class="sil"><a href="<?php echo U('Shop/senduptodate');?>"><i class="fa fa-cog push"></i>Send email<i class="fa fa-angle-right"></i></a><span class="hover"></span>
    </li>
  </ul>
</div>
<?php
...
<?php
    ...
    <div class="col-main" style="margin-left:250px">
        ...
        <form action="" method="post" id="form-validate" class="registerform">
            ...
            <ul class="form-list">
			<?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "有好东西记得分享哦~" ;else: foreach($__LIST__ as $key=>$bookboxs): $mod = ($k % 2 );++$k;?><li>
            ...
            </li><?php endforeach; endif; else: echo "有好东西记得分享哦~" ;endif; ?>
