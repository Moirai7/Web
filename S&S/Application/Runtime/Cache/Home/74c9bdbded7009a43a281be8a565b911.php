...
<!--start slider -->
<link rel="stylesheet" href=/S&S/Public/css/fwslider.css media="all">
<script src=/S&S/Public/js/jquery-ui.min.js></script>
<script src=/S&S/Public/js/css3-mediaqueries.js></script>
<script src=/S&S/Public/js/fwslider.js></script>
<!--end slider -->
<script src=/S&S/Public/js/jquery.easydropdown.js></script>
</head>
<body>
<div id="container ">
    ...
    <div id="fwslider">
        <div class="slider_container">
            <div class="slide"> 
                <!-- Slide image -->
                    <img src=/S&S/Public/images/banner.jpg alt=""/>
                <!-- /Slide image -->
                <!-- Texts container -->
            ...
            <div class="slide">
                <img src=/S&S/Public/images/banner1.jpg alt=""/>
                <div class="slide_content">
                    <div class="slide_content_wrap">
	...
	<div class="wrap">
		<div class="section group">
		  ...
		  <div class="top-box1">
		    <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "有好东西记得分享哦~" ;else: foreach($__LIST__ as $key=>$bookboxs): $mod = ($k % 2 );++$k;?><div class="col_1_of_3 span_1_of_3"> 
				<div class="inner_content clearfix">
  <a href="<?php echo U('Shop/book','id='.$bookboxs['isbn']);?>">
					<div class="product_image">
						<img src=/S&S/Public/upload/<?php echo $bookboxs['images']?>  alt=""/>
					</div>
</a>
                     <?php  if($bookboxs['new']){ if(intval((strtotime()-strtotime(date('y-m-d', $bookboxs['addtime'])))/86400)<=3) { echo '<div class="sale-box"><span class="on_sale title_shop">New</span></div>'; }else{ $Shop = M('Shop'); $data['new']=0; $condition['isbn']=$bookboxs['isbn']; $Shop->where($condition)->save($data); } }?>
<?php  if($bookboxs['sale']) echo '<div class="sale-box1"><span class="on_sale title_shop">sale</span></div>' ?>
			...
			</div><?php endforeach; endif; else: echo "有好东西记得分享哦~" ;endif; ?>
			<div class="clear"></div>
		  </div>	
		  <h2 class="head">Staff Pick</h2>
		  <div class="top-box1">
		   <?php if(is_array($click)): $k = 0; $__LIST__ = $click;if( count($__LIST__)==0 ) : echo "有好东西记得分享哦~" ;else: foreach($__LIST__ as $key=>$bookboxs2): $mod = ($k % 2 );++$k;?><div class="col_1_of_3 span_1_of_3">
				<div class="inner_content clearfix">
<a href="<?php echo U('Shop/book','id='.$bookboxs2['isbn']);?>">
					<div class="product_image">
						<img src=/S&S/Public/upload/<?php echo $bookboxs2['images']?>  alt=""/>
					</div>
                     <?php  if($bookboxs2['new']){ if(intval((strtotime()-strtotime(date('y-m-d', $bookboxs2['addtime'])))/86400)<=3) { echo '<div class="sale-box"><span class="on_sale title_shop">New</span></div>'; }else{ $Shop = M('Shop'); $data['new']=0; $condition['isbn']=$bookboxs2['isbn']; $Shop->where($condition)->save($data); } }?>
<?php  if($bookboxs2['sale']) echo '<div class="sale-box1"><span class="on_sale title_shop">sale</span></div>' ?>	
		    ...
		    <div class="section group">
			  <?php if(is_array($price)): $k = 0; $__LIST__ = $price;if( count($__LIST__)==0 ) : echo "有好东西记得分享哦~" ;else: foreach($__LIST__ as $key=>$bookboxs3): $mod = ($k % 2 );++$k;?><div class="col_1_of_3 span_1_of_3">
				<div class="inner_content clearfix">
<a href="<?php echo U('Shop/book','id='.$bookboxs3['isbn']);?>">
					<div class="product_image">
						<img src=/S&S/Public/upload/<?php echo $bookboxs3['images']?>  alt=""/>
					</div>
                     <?php  if($bookboxs['new']){ if(intval((strtotime()-strtotime(date('y-m-d', $bookboxs3['addtime'])))/86400)<=3) { echo '<div class="sale-box"><span class="on_sale title_shop">New</span></div>'; }else{ $Shop = M('Shop'); $data['new']=0; $condition['isbn']=$bookboxs3['isbn']; $Shop->where($condition)->save($data); } }?>
