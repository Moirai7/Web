...
<div id="container ">
  ...
  <div class="main">
     <div class="wrap">
		...
		<ul class="megamenu skyblue">
				<li><a href=<?php echo U('Shop/booklist',array('id'=>$id,'level'=>1));?>>Home Level</a></li>
				<li><a href=<?php echo U('Shop/booklist',array('id'=>$id,'level'=>2));?>>Enterprise Level</a></li>
				<li><a href=<?php echo U('Shop/booklist',array('id'=>$id,'level'=>4));?>>按添加时间</a></li>
				<li><a href=<?php echo U('Shop/booklist',array('id'=>$id,'level'=>5));?>>按点击量</a></li>
				<li><a href=<?php echo U('Shop/booklist',array('id'=>$id,'level'=>6));?>>按价格</a></li>
			</ul>
		<div class="top-box">
...
　<li><a  href="<?php echo U('Shop/booklist?id='.$id.'&page='.$first);?>">首页</a></li>
　<li><a  href="<?php echo U('Shop/booklist?id='.$id.'&page='.$pagepre);?>">&lt;&lt;</a></li>
<?php } if($page<7&&$counts>7){?>
<li><a  href="{:U('Shop/booklist?id='.$id.'&page=1')}">1</a></li>
<li><a  href="<?php echo U('Shop/booklist?id='.$id.'&page=2');?>">2</a></li>
<li><a  href="<?php echo U('Shop/booklist?id='.$id.'&page=3');?>">3</a></li>
<li><a  href="<?php echo U('Shop/booklist?id='.$id.'&page=4');?>">4</a></li>
<li><a  href="<?php echo U('Shop/booklist?id='.$id.'&page=5');?>">5</a></li>
<li><a  href="<?php echo U('Shop/booklist?id='.$id.'&page=6');?>">6</a></li>
<li><a  href="<?php echo U('Shop/booklist?id='.$id.'&page=7');?>">7</a></li>
<li><a  href="">...</a></li>
<?php }elseif($page<7&&$counts<7){ for($i=1;$i<=$counts;$i++){ ?>
<li><a  href="<?php echo U('Shop/booklist?id='.$id.'&page='.$i);?>"><?php echo $i;?></a></li>
<?php } }elseif($page>7&&$page<$counts-7){?>
<li><a  href="{:U('Shop/booklist?id='.$id.'&page=1')}">1</a></li>
<li><a  href="<?php echo U('Shop/booklist?id='.$id.'&page=2');?>">2</a></li>
<li><a  href="">...</a></li>
<li><a  href="<?php echo U('Shop/booklist?id='.$id.'&page='.$page-1);?>">$page</a></li>
<li><a  href="<?php echo U('Shop/booklist?id='.$id.'&page='.$page);?>">$page+1</a></li>
<li><a  href="<?php echo U('Shop/booklist?id='.$id.'&page='.$page+1);?>">$page+2</a></li>
<li><a  href="<?php echo U('Shop/booklist?id='.$id.'&page='.$page+2);?>">$page+3</a></li>
<li><a  href="">...</a></li>
<?php }elseif($page<7&&$counts<7){ for($i=1;$i<=$counts;$i++){ ?>
<li><a  href="<?php echo U('Shop/booklist?id='.$id.'&page='.$i);?>"><?php echo $i;?></a></li>
<?php } } if($page<$counts){ ?>
　<li><a  href="<?php echo U('Shop/booklist?id='.$id.'&page='.$next);?>">&gt;&gt;</a></li>
　<li><a  href="<?php echo U('Shop/booklist?id='.$id.'&page='.$last);?>">最后一页</a></li>
<?php } ?>
		  	</ul>
	   		<div class="clear"></div>
    		</div>
