...
if ($page > 1)
{ ?>
　<li><a  href="{:U('Shop/search?page='.$first)}">首页</a></li>
　<li><a  href="{:U('Shop/search?page='.$pagepre)}">&lt;&lt;</a></li>
<?php }


if($page<7&&$counts>7){?>
<li><a  href="{:U('Shop/search?page=1')}">1</a></li>
<li><a  href="{:U('Shop/search?page=2')}">2</a></li>
<li><a  href="{:U('Shop/search?page=3')}">3</a></li>
<li><a  href="{:U('Shop/search?page=4')}">4</a></li>
<li><a  href="{:U('Shop/search?page=5')}">5</a></li>
<li><a  href="{:U('Shop/search?page=6')}">6</a></li>
<li><a  href="{:U('Shop/search?page=7')}">7</a></li>
<li><a  href="">...</a></li>
<?php }elseif($page<7&&$counts<7){
for($i=1;$i<=$counts;$i++){ 
?>
<li><a  href="{:U('Shop/search?&page='.$i)}"><?php echo $i;?></a></li>
<?php } }elseif($page>7&&$page<$counts-7){?>
<li><a  href="{:U('Shop/search?page=1')}">1</a></li>
<li><a  href="{:U('Shop/search?page=2')}">2</a></li>
<li><a  href="">...</a></li>
<li><a  href="{:U('Shop/search?page='.$page-1)}">$page</a></li>
<li><a  href="{:U('Shop/search?page='.$page)}">$page+1</a></li>
<li><a  href="{:U('Shop/search?page='.$page+1)}">$page+2</a></li>
<li><a  href="{:U('Shop/search?page='.$page+2)}">$page+3</a></li>
<li><a  href="">...</a></li>
<?php }elseif($page<7&&$counts<7){
for($i=1;$i<=$counts;$i++){ 
?>
...
<?php } }
if($page<$counts){ ?>
　<li><a  href="{:U('Shop/search?page='.$next)}">&gt;&gt;</a></li>
　<li><a  href="{:U('Shop/search?page='.$last)}">最后一页</a></li>
<?php } ?>
		  	</ul>
	   		<div class="clear"></div>
    		</div>
