                    ...
                    <section id="middle">\
                        <div class="panel panel-default shadow-effect">\
                            <div class="col-xs-12 panel-header">\
                                ...
                                </div>\<span class="hot-tag">推荐</span>\
                            </div>\
                            <div class="panel-body ">\
                                <ul class="list-unstyled">\
                                    <li>月薪： <%=u.Challenge_Salary%></li>\
                                    <li>职位诱惑：</li>\
                                    <li>\
                                        <ul class="companyTags">\
										<li><%=u.Challenge_Position0%></li>\
										<li><%=u.Challenge_Position1%></li>\
										<li><%=u.Challenge_Position2%></li>\
                                        </ul>\
                                    </li>\
                                    <li>挑战项目：</li>\
                                    <li>\
							        <ul>\
						         		<li><%=u.Challenge_Quiz0%></li>\
										<li><%=u.Challenge_Quiz1%></li>\
										<li><%=u.Challenge_Quiz2%></li>\
						            </ul>\
                                    </li>\
                                    <li>难度：\
	          							<% for (var j = 0; j < u.Challenge_Level; j ++) { %><i class="fa fa-star"></i><%}%>\
                                    <li><i class="fa fa-calendar"></i><%=u.Challenge_EnTime%></li>\
                                    <li><i class="fa fa-user"></i><%=u.Challenge_Num%>人已接受挑战</li>\
                                </ul>\
                            </div><!-- /.panel-body -->\
