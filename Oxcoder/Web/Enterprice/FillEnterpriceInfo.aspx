<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FillEnterpriceInfo.aspx.cs" Inherits="Web.Enterprice.FillEnterpriceInfo" %>
					...
					<div class="row">
					   <font color="red"></font>
						<form id="defaultForm" runat="server" class="form-vertical bv-form" enctype="multipart/form-data" novalidate="novalidate"><button type="submit" class="bv-hidden-submit" style="display: none; width: 0px; height: 0px;"></button>
							<input id="input-provincework" type="hidden" value=""> <input id="input-citywork" type="hidden" value=""> <img src="../Public/Images/corp_step1.png">

							<div class="form-group">
								<label><h3 class="grey">公司全称</h3></label> <input runat="server" type="text" id="corpname" name="cname" class="form-control" placeholder="请输入公司全称" value="">
							</div>

							<div class="form-group">
								<label><h3 class="grey">公司简称</h3></label> <input runat="server" type="text" id="corpsname" name="cnameshort" class="form-control" placeholder="请输入公司简称" value="" data-bv-field="cnameshort"> <span class="text-danger" id="error1" style="display: none;">请输入公司简称</span>
							...
							<div class="form-group">
								<label><h3 class="grey">公司LOGO</h3></label> <input runat="server" type="file" name="image" tabindex="-1" style="position: fixed; left: -500px;" id="corppic" accept="image/*"><div class="bootstrap-filestyle input-group"><input type="text" class="form-control " disabled="" placeholder="Choose file"> <span class="input-group-btn" tabindex="0">  <label for="corp-pic" class="btn btn-default">	<span class="glyphicon glyphicon-folder-open"></span>   </label></span></div> <span class="text-danger" id="error2" style="display: none;">请上传公司logo</span> <span class="help-block" id="hint2"></span>
							</div>

							<div class="form-group">
								<label><h3 class="grey">公司网址</h3></label> <input runat="server" type="text" id="webPosition" name="website" class="form-control" placeholder="请输入公司网址" value="" data-bv-field="website"> <span class="help-block">非必填</span>
							...
							<div class="form-group">
								...
								<textarea runat="server" id="corpinfo" name="cdes" rows="9" class="form-control" placeholder="请详细描述公司简介、企业文化等" data-bv-field="cdes">								</textarea>
